...
class CashManager:
    ...
    def get_balance(self, strategy_id: str):
    ...
    def get_tranche_size(self, strategy_id: str) -> float:
        total, _ = self.get_balance(strategy_id)
        return total * self.TRANCHE_RATIO

    def allocate(self, strategy_id: str) -> bool:
        """
        Attempt to allocate 1 tranche of capital.
        Returns True if successful, False if insufficient funds.
        """
        total, available = self.get_balance(strategy_id)
    ...
    def release(self, strategy_id: str, tranches_held: int, pnl_pct: float):
        """
